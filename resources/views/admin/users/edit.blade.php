        ...
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nip') ? 'is-invalid' : '' }}" type="text" name="nip" id="nip" value="{{ old('nip', $user->nip) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mobilephone') ? 'is-invalid' : '' }}" type="text" name="mobilephone" id="mobilephone" value="{{ old('mobilephone', $user->mobilephone) }}" required>
          ...
          <div class="form-group">
                ...
                <div class="row">
                    <div class="col">
                            ...
                            <input class="form-control {{ $errors->has('pob') ? 'is-invalid' : '' }}" type="text" name="pob" id="pob" value="{{ old('pob', $user->pob) }}" required>
                            @if($errors->has('pob'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('pob') }}
                                </div>
                        ...
                        <div class="col">
                            ...
                            <input class="form-control {{ $errors->has('dob') ? 'is-invalid' : '' }} date" type="date" name="dob" id="dob" value="{{ old('dob', $user->dob) }}" required>
                            @if($errors->has('dob'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('dob') }}
                                </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control map-input {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text" name="address" id="address" value="{{ old('address',$user->address) }}">
                <input type="hidden" name="latitude" id="address-latitude" value="{{ old('latitude' , $user->latitude) }}" />
                <input type="hidden" name="longitude" id="address-longitude" value="{{ old('longitude' , $user->longitude) }}" />
